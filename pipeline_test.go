...
// 			Generator: "echo steps: [ trigger: 'service-1' ]",
// 		},
// 		{
// 			Paths: []string{"watch-path-2/", "watch-path-3/", "watch-path-4"},
// 			// Step:  pipeline.TriggerStep{Trigger: "service-2"},
// 		},
// 		{
// 			Paths: []string{"watch-path-5"},
// 			// Step:  pipeline.TriggerStep{Trigger: "service-3"},
// 		},
// 		{
// 			Paths: []string{"watch-path-2"},
// 			// Step:  pipeline.TriggerStep{Trigger: "service-4"},
// 		},
// 	}
...
func TestPipelinesDynamicStepsToTrigger(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"service-1": {
			...
			WatchConfigs: []WatchConfig{
				{
					Paths:     []string{"watch-path-1"},
					Generator: "bash -c 'echo steps: [ command: foo ]'",
				},
			},
			Expected: []pipeline.Step{
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			expectedOut, err := yaml.Marshal(tc.Expected)
			assert.NoError(t, err)
